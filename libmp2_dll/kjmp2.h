...
// decoder instance.
DLL_EXPORT void kjmp2_init(kjmp2_context_t *mp2);
...
//               isn't valid.
DLL_EXPORT int kjmp2_get_sample_rate(const unsigned char *frame);
...
DLL_EXPORT unsigned long kjmp2_decode_frame(
    kjmp2_context_t *mp2,
