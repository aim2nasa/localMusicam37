...
int twolame_set_rawmode (twolame_options *glopts, int rawmode)
{
	glopts->rawmode = rawmode;
	return(0);
}

int twolame_get_rawmode (twolame_options *glopts)
{
	return(glopts->rawmode);
}
...
int twolame_set_samplesize (twolame_options *glopts, int samplesize)
{  
	glopts->samplesize = samplesize;
	return(0);
}

int twolame_get_samplesize (twolame_options *glopts)
{
	return(glopts->samplesize);
}

int twolame_set_samplefloat (twolame_options *glopts, int samplefloat)
{  
	glopts->samplefloat = samplefloat;
	return(0);
}

int twolame_get_samplefloat (twolame_options *glopts)
{
	return(glopts->samplefloat);
}
